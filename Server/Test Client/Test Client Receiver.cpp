...
const std::byte* test::ReceiveSignInFailurePacket(const std::byte* buffer, int& error)
{
...
const std::byte* test::ReceiveRoomCreatedPacket(const std::byte* buffer, IdType& room_id)
{
...
const
std::byte* test::ReceiveRoomJoinedPacket(const std::byte* buffer, IdType& client_id)
{
