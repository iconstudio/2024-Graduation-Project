...
{
	[[nodiscard]]
	constexpr string to_string(const ERoomContract& ctr)
	{
		using enum ERoomContract;
		switch (ctr)
		{
	...
	[[nodiscard]]
	constexpr wstring to_wstring(const ERoomContract& ctr)
	{
		using enum ERoomContract;
		switch (ctr)
		{
...
template<>
struct std::formatter<ERoomContract, char>
{
	...
	static format_context::iterator
		format(const ERoomContract& ctr, format_context& context)
	{
		using enum ERoomContract;
		switch (ctr)
		{
	...
	static format_context::iterator
		format(ERoomContract&& ctr, format_context& context)
	{
		using enum ERoomContract;
		switch (std::move(ctr))
		{
...
template<>
struct std::formatter<ERoomContract, wchar_t>
{
	...
	static wformat_context::iterator
		format(const ERoomContract& ctr, wformat_context& context)
	{
		using enum ERoomContract;
		switch (ctr)
		{
	...
	static wformat_context::iterator
		format(ERoomContract&& ctr, wformat_context& context)
	{
		using enum ERoomContract;
		switch (std::move(ctr))
		{
