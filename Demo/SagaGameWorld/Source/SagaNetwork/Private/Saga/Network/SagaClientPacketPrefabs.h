...
#pragma pack(push, 1)
	...
	struct CS_RpcPacket : public FSagaBasicPacket
	{
	...
	/// <remarks>Client would send it to the server</remarks>
	struct CS_CreateRoomPacket : public FSagaBasicPacket
	{
		using Super = FSagaBasicPacket;
	...
	/// <param name="z"/>
	/// <remarks>Client would send it to the server</remarks>
	struct CS_UpdatePositionPacket : public FSagaBasicPacket
	{
		using Super = FSagaBasicPacket;
	...
	/// <remarks>Client would send it to the server</remarks>
	struct CS_SignInPacket : public FSagaBasicPacket
	{
		using Super = FSagaBasicPacket;
